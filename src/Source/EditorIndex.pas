...
uses Globals, HelpMap, Tools, MarathonIDE, CompileDBObject, MarathonProjectCache;
...
begin
	...
	begin
		qryIndex.Database := nil;
		FIsInterbase6 := False;
		FSQLDialect := 0;
		Exit;
	end;
	qryIndex.Database := Conn.Connection;
	qryIndex.Transaction := Conn.Transaction;
