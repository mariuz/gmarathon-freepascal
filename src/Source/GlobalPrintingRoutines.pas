...
uses {$IFDEF FPC} LCLIntf, LCLType, LMessages, {$ELSE} Windows, Messages, {$ENDIF} SysUtils, Classes, Graphics, Controls, Forms, Dialogs, ExtCtrls, DB, Printers, Registry, Chart, PagePrnt, DSprint, SynEdit, SyntaxMemoWithStuff2, SQLDB, GSSRegistry, MarathonProjectCacheTypes, MarathonProjectCache, GlobalPrintDialog;
