; *** Inno Setup versione 4.0.5+ messaggi Italiani ***
;
...
;
;
; Tradotto da Ale5000 - ale5000@tiscali.it
...
; *** SetupLdr messages
SetupLdrStartupMessage=Questa è l'installazione di %1. Volete continuare?
LdrCannotCreateTemp=Impossibile creare i file temporanei. Installazione annullata
LdrCannotExecTemp=Impossibile eseguire i file nella directory temporanea. Installazione annullata

; *** Startup error messages
LastErrorMessage=%1.%n%nErrore %2: %3
SetupFileMissing=File %1 non trovato nella directory di installazione. Correggere il problema o richiedere una nuova copia del software.
SetupFileCorrupt=I file di installazione sono danneggiati. Richiedere una nuova copia del software.
SetupFileCorruptOrWrongVer=I file di installazione sono danneggiati, oppure sono incompatibili con questa versione dell'installer. Correggere il problema o richiedere una nuova copia del software.
...
SetupAppRunningError=L'installer ha trovato che %1 è attualmente in esecuzione.%n%nChiudere adesso tutte le istanze del programma e poi premere OK, oppure premere Annulla per uscire.
UninstallAppRunningError=Uninstall ha trovato che %1 è attualmente in esecuzione.%n%nChiudere adesso tutte le istanze del programma e poi premere OK, oppure premere Annulla per uscire.
...
LicenseLabel=Leggere le importanti informazioni che seguono prima di procedere.
LicenseLabel3=Leggere il seguente accordo di licenza. È necessario accettare i termini di questo accordo per procedere con l'installazione.
...
InfoBeforeClickLabel=Quando siete pronti per proseguire, premere Avanti.
WizardInfoAfter=Informazioni
InfoAfterLabel=Leggere le importanti informazioni che seguono prima di procedere.
InfoAfterClickLabel=Quando siete pronti per proseguire, premere Avanti.
...
SelectDirDesc=Dove volete installare [name]?:
SelectDirLabel=Selezionare la cartella dove installare [name], poi premere Avanti.
DiskSpaceMBLabel=Il programma richiede almeno [mb] MB di spazio sul disco.
ToUNCPathname=L'installer non può installare su un percorso UNC. Se state installando attraverso una rete, dovete connettere la risorsa come una unità di rete.
InvalidPath=Dovete inserire un percorso completo di lettera di unità; per esempio:%n%nC:\APP%n%no un percorso UNC nella forma:%n%n\\server\share
...
DiskSpaceWarning=L'installazione richiede almeno %1 KB di spazio libero per installare, ma l'unità selezionata ha solo %2 KB disponibili.%n%nVolete continuare comunque?
...
DirExists=La cartella:%n%n%1 esiste già.%n%nVolete utilizzarla comunque?
DirDoesntExistTitle=Cartella inesistente
DirDoesntExist=La cartella:%n%n%1%n%nnon esiste. Volete crearla?

; *** "Select Components" wizard page
WizardSelectComponents=Selezione componenti
SelectComponentsDesc=Quali componenti devono essere installati?
SelectComponentsLabel2=Selezionare i componenti da installare; cancellare quelli che non volete installare. Premere Avanti per continuare.
...
NoUninstallWarning=L'installazione ha rilevato che i seguenti componenti sono già installati sul vostro computer:%n%n%1%n%nDeselezionando questi componenti non verranno disinstallati.%n%nVolete continuare comunque?
ComponentSize1=%1 KB
ComponentSize2=%1 MB
...
SelectTasksDesc=Quali processi addizionali volete avviare?
SelectTasksLabel2=Selezionare i processi addizionali che l'installazione eseguirà installando [name], poi premere Avanti.

; *** "Select Start Menu Folder" wizard page
WizardSelectProgramGroup=Selezione cartella Menu Avvio/Start
SelectStartMenuFolderDesc=Dove volete che l'installazione inserisca il collegamento al programma?
SelectStartMenuFolderLabel=Selezionare la cartella nel Menu Avvio/Start nella quale creare i collegamenti del programma, poi premere Avanti.
NoIconsCheck=&Non creare nessuna Icona
MustEnterGroupName=Dovete inserire il nome della cartella.
...
ReadyLabel1=L'installer è pronto per iniziare l'installazione di [name] sul vostro computer.
...
PreparingDesc=L'installer sta preperando l'installazione di [name] sul vostro computer.
PreviousInstallNotCompleted=L'installazione/disinstallazione precedente del programma non è stata completata. È necessario riavviare il computer per completare l'installazione.%n%nAl successivo riavvio del sistema eseguire di nuovo l'installer per completare l'installazione di [name].
CannotContinue=L'installazione non può continuare. Premere Annulla per uscire.

; *** "Installing" wizard page
WizardInstalling=Installazione in corso
InstallingLabel=Attendere che l'installer installi [name] sul vostro computer.

; *** "Setup Completed" wizard page
FinishedHeadingLabel=Completamento dell'installazione guidata di [name]
FinishedLabelNoIcons=L'installer ha terminato di installare [name] sul vostro computer.
FinishedLabel=L'installer ha terminato di installare [name] sul vostro computer. L'applicazione può essere eseguita selezionando l'icona installata.
ClickFinish=Premere Termina per uscire dall'installazione.
FinishedRestartLabel=Per completare l'installazione di [name], bisogna riavviare il computer. Volete riavviare ora?
FinishedRestartMessage=Per completare l'installazione di [name], bisogna riavviare il computer.%n%nVolete riavviare ora?
...
StatusCreateIcons=Creazione scorciatoie...
...
StatusRunProgram=Installazione al termine...
...
; *** File copying errors
FileAbortRetryIgnore=Premere Riprova per tentare di nuovo, Ignora per saltare questo file (sconsigliato), o Annulla per terminare l'installazione.
...
ExistingFileNewer=Il file esistente è più recente di quello che si stà installando. Si raccomanda di mantenere il file esistente.%n%nVolete mantenere il file esistente?
...
ErrorRestartingComputer=L'installer non riesce a riavviare il computer. Riavviare manualmente.
...
UninstallUnsupportedVer=Il file log di disinstallazione "%1" è in un formato non riconosciuto da questa versione dell'uninstaller. Impossibile disinstallare
UninstallUnknownEntry=Trovata una voce sconosciuta (%1) nel file di log della disinstallazione
ConfirmUninstall=Siete sicuri di voler rimuovere completamente %1 e tutti i suoi componenti?
OnlyAdminCanUninstall=Questa applicazione può essere disinstallata solo da un utente con privilegi di Amministratore.
UninstallStatusLabel=Attendere fino a che %1 e stato rimosso dal vostro computer.
...
UninstalledAndNeedsRestart=Per completare la disinstallazione di %1, è necessario riavviare il sistema.%n%nVolete riavviare adesso?
...
ConfirmDeleteSharedFile2=Il sistema indica che il seguente file condiviso non è più usato da nessun programma. Volete che Uninstall rimuova questo file condiviso?%n%nSe qualche programma usasse questo file, questi potrebbero non funzionare più correttamente. Se non siete sicuri, scegliere No. Lasciare il file nel vostro sistema non può causare danni.
