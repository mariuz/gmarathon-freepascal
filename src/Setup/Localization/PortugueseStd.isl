; *** Inno Setup version 4.0.0+ Portuguese (Standard) messages ***
;
; Author: NARS
; URL: http://nars.cjb.net
...
SelectDirLabel=Escolha a pasta onde quer instalar o [name] e de seguida clique em Seguinte.
...
SelectTasksLabel2=Seleccione as tarefas adicionais que deseja que o Assistente de Instalação execute na instalação do [nome] e em seguida clique em Seguinte.
...
SelectStartMenuFolderLabel=Escolha a pasta do Menu Iniciar onde devem ser criados os ícones de atalho do programa e em seguida clique em Seguinte.
...
SelectDirectory=Escolha a directoria
